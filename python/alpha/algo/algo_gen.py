...
def BARSLAST(input: np.ndarray | list[np.ndarray]) -> np.ndarray | list[np.ndarray]:
  """
...
def BARSSINCE(input: np.ndarray | list[np.ndarray]) -> np.ndarray | list[np.ndarray]:
  """
...
def FRET(
  open: np.ndarray | list[np.ndarray],
  close: np.ndarray | list[np.ndarray],
  is_calc: np.ndarray | list[np.ndarray],
  delay: int,
  periods: int,
) -> np.ndarray | list[np.ndarray]:
  """
...
def RANK(input: np.ndarray | list[np.ndarray]) -> np.ndarray | list[np.ndarray]:
  """
...
def SUMIF(
  ...
  condition: np.ndarray | list[np.ndarray],
  periods: int,
) -> np.ndarray | list[np.ndarray]:
  """
